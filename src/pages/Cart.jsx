      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 bg-white rounded-xl shadow-sm">
          ...
          {cartItems.map(item => (
            <div
              key={item.id}
              className="flex gap-6 px-6 py-6 border-b last:border-b-0"
            >
              {/* Image */}
              <img
                src={item.image}
        ...
        <div className="lg:col-span-4">
          <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
            ...
            <button className="mt-6 w-full bg-black text-white py-4 rounded-lg hover:bg-gray-800 transition font-medium">
              Proceed to Checkout
            </button>
